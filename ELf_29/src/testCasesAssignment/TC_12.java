...
public class TC_12 {
	...
	public static void main(String[] args) {
		//step1: opening the browser
				...
				firstName.sendKeys("jamal2");
				String expectedFirstName = "jamal2";
				...
				String expectedTeamSellingText = "Team Selling";
				String actualTeamSellingText = driver.findElement(By.xpath("//option[text()='Team Selling']")).getText();
				
				if(actualTeamSellingText.equals(expectedTeamSellingText)) {
					System.out.println("Selected TeamSellingtGroup Is Successfully");
				}else {
					System.err.println("Selected TeamSellingtGroup Is UnSuccessfully");
				}
				...
				driver.findElement(By.xpath("//a[text()='Contacts']")).click();
				String expectedContactUsername="jamal2";
				String actualContactUserName= driver.findElement(By.linkText("jamal2")).getText();
