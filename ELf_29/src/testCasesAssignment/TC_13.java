...
public class TC_13 {
	...
	public static void main(String[] args) {
		...
		//step7: Delete Multiple contacts 
		driver.findElement(By.xpath("//a[text()='jamal2']/../..//input[@name='selected_id']")).click();
		driver.findElement(By.xpath("//a[text()='jamal1']/../..//input[@name='selected_id']")).click();
